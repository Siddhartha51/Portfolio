    ...
    <>
      <div className="w-full min-h-screen flex items-center justify-center bg-gray-950">
        ...
        <div className="text-white space-y-4 max-w-xl">
          ...
          <button className="bg-purple-600 hover:bg-purple-700 px-6 py-3 rounded-lg font-bold cursor-pointer">View Work</button>
          <button className="bg-transparent border border-gray-600 hover:bg-gray-900 px-6 py-3 rounded-lg font-bold cursor-pointer">Contact Me</button>
          </div>
        </div>
